...
interface StayDataSets extends DataSets {
  label: string
}
interface StayDisplayData extends DisplayData {
  datasets: StayDataSets[]
}
...
type Data = {
  canvas: boolean
  chartData: typeof stayData
  date: string
  agencies: VueI18n.TranslateResult[]
}
type Methods = {}
type Computed = {
  displayData: StayDisplayData
