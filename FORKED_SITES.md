...
------------ | ------------- | ------------- | -------------
長野県（このサイト）|https://stopcovid19.metro.tokyo.lg.jp|長野県（**公式**）|[tokyo-metropolitan-gov/covid19](https://github.com/tokyo-metropolitan-gov/covid19)|
...
1. 長野県: 先頭で固定とする。
1. 長野県以外: 厚生労働省発行のPDF([都道府県番号 - tp0727-1d.pdf](https://www.mhlw.go.jp/topics/2007/07/dl/tp0727-1d.pdf))に従って、表に以下の情報を追加する。
   - 公開しているサイト: URLを記載する。
   - プロジェクト
